...
const SYSTEM_PROMPT =
  ...
  "didactico). Evita repetir. Si hace mas de 30 minutos del ultimo resumen y hubo actividad, " +
  "prioriza resumen. Si esta todo tranquilo, alterna educativo y recorrido. Responde SOLO un " +
  'objeto JSON: {"kind":"recorrido|resumen|educativo"}.';
